...
export function loadWhisper(model) {
  const bucket = `https://d1f345f86da5a0035b75e9734d3e2d98.r2.cloudflarestorage.com/ai-interviewer`
  const models_url = `${bucket}/models/whisper`
  let urls = {
    'tiny.en': `${models_url}/ggml-model-whisper-tiny.en.bin`,
    'tiny': `${models_url}/ggml-model-whisper-tiny.bin`,
    'base.en': `${models_url}/ggml-model-whisper-base.en.bin`,
    'base': `${models_url}/ggml-model-whisper-base.bin`,
    'small.en': `${models_url}/ggml-model-whisper-small.en.bin`,
    'small': `${models_url}/ggml-model-whisper-small.bin`,

    'tiny-en-q5_1': `${models_url}/ggml-model-whisper-tiny.en-q5_1.bin`,
    'tiny-q5_1': `${models_url}/ggml-model-whisper-tiny-q5_1.bin`,
    'base-en-q5_1': `${models_url}/ggml-model-whisper-base.en-q5_1.bin`,
    'base-q5_1': `${models_url}/ggml-model-whisper-base-q5_1.bin`,
    'small-en-q5_1': `${models_url}/ggml-model-whisper-small.en-q5_1.bin`,
    'small-q5_1': `${models_url}/ggml-model-whisper-small-q5_1.bin`,
    'medium-en-q5_0': `${models_url}/ggml-model-whisper-medium.en-q5_0.bin`,
    'medium-q5_0': `${models_url}/ggml-model-whisper-medium-q5_0.bin`,
    'large-q5_0': `${models_url}/ggml-model-whisper-large-q5_0.bin`,
  };
