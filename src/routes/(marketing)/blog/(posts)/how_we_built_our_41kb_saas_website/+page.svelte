...
<p>
  We've written a detailed blog post about how we took this template, and created a real <a
    href="https://criticalmoments.io"
    target="_blank">SaaS company website</a
  >. Topics include:
</p>
...
<p>
  If you are looking for examples of blog posts with rich content rendered inside this template,
  checkout the other demo posts <a href="/blog" class="link">here</a>.
</p>
