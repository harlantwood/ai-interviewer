...
<div id="model">
	...
	<button id="fetch-whisper-small-en" on:click={() => loadWhisper('small.en')}
		>small.en (466 MB)</button
	>
	...
	>
	<button id="fetch-whisper-small-q5_1" on:click={()=> loadWhisper('small-q5_1')}
